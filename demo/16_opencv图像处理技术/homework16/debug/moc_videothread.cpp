...
QT_MOC_LITERAL(3, 27, 6), // "frame1"
QT_MOC_LITERAL(4, 34, 6) // "frame2"

    },
    "videoThread\0sendFrame2Win\0\0frame1\0"
    "frame2"
};
...
void videoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendFrame2Win((*reinterpret_cast< QImage(*)>(_a[1])),(*reinterpret_cast< QImage(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (videoThread::*_t)(QImage , QImage );
...
// SIGNAL 0
void videoThread::sendFrame2Win(QImage _t1, QImage _t2)
{
